...
namespace PartyProduct_Exercise_03.Migrations
{
    ...
    [Migration("20221001073537_UpdatedcolumninInvoice")]
    partial class UpdatedcolumninInvoice
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PartyProduct_Exercise_03.Data.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PartyProduct_Exercise_03.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PartyProduct_Exercise_03.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PartyProduct_Exercise_03.Data.AssignParty", b =>
                {
                    b.HasOne("PartyProduct_Exercise_03.Data.Party", "Party")
                        .WithMany()
                        .HasForeignKey("PartyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PartyProduct_Exercise_03.Data.Product", "Product")
                        .WithMany()
